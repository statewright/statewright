...
> **Statewright Plugin 0.3.0 for [Claude](https://github.com/statewright/statewright/releases/tag/claude-v0.3.0-r1) and [Codex](https://github.com/statewright/statewright/releases/tag/codex-v0.3.0-r1) is released:** native autonomous model routing now works in both TUIs. Assign a model, reasoning level, tool policy, and budget to each workflow phase while your agent continues through bounded work in the interface you already use. [Learn more at statewright.ai →](https://statewright.ai)
